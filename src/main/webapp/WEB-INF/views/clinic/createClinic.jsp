...
<head>
    <meta charset="UTF-8">
    <title>Create Clinic | PeriDesk</title>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Create New Clinic</h4>
                    </div>
                    <div class="card-body">
                        <form:form action="/clinics" method="post" modelAttribute="clinic">
                            ...
                            <div class="form-group">
                                ...
                                <a href="/clinics" class="btn btn-secondary ml-2">Cancel</a>
                            </div>
                        </form:form>
                    </div>
                </div>
