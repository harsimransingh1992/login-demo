...
<html>
<head>
    <title>Edit Procedure Price - PeriDesk Admin</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form:form method="POST" action="${pageContext.request.contextPath}/admin/prices/${procedure.id}/edit" modelAttribute="procedure">
                <form:hidden path="id" />
