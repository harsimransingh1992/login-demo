...
<html>
<head>
    <title>Create Doctor Target - PeriDesk</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <p>Create a new target configuration for doctors based on their clinic's city tier.</p>
            
            <form method="POST" action="${pageContext.request.contextPath}/admin/targets/create">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monthlyRevenueTarget" name="monthlyRevenueTarget" class="form-control" 
                           step="0.01" min="0" required placeholder="e.g., 500000">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monthlyProcedureTarget" name="monthlyProcedureTarget" class="form-control" 
                           min="1" required placeholder="e.g., 150">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3" 
                              placeholder="Optional description for this target configuration"></textarea>
        ...
        <div class="card">
            <h3>Target Guidelines</h3>
            <ul>
                <li><strong>Tier 1 (Metro Cities):</strong> Higher targets due to larger patient base and higher procedure costs</li>
                <li><strong>Tier 2 (Large Cities):</strong> Medium targets for established markets</li>
                <li><strong>Tier 3 (Small Cities):</strong> Standard targets for developing markets</li>
                <li><strong>Tier 4 (Rural Areas):</strong> Lower targets for smaller markets</li>
            </ul>
            <p><em>Note: Only one active target can exist per city tier. Creating a new target for an existing tier will replace the current one.</em></p>
        </div>
    </div>
