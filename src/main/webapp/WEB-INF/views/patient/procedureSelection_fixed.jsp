            ...
            <div class="procedure-container">
                ...
                <div class="examination-details">
                    ...
                    <div class="selected-procedures-info">
                        <span><span id="selected-count">0</span> procedure selected</span>
                        <div class="submit-area">
                            ...
                            <div class="action-buttons-container">
                                <button id="view-selected-procedures" class="btn btn-secondary btn-narrow">
                                    <i class="fas fa-eye"></i>&nbsp;View Saved Procedure
                                </button>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitButton.addEventListener('click', async function() {
                ...
                try {
                    ...
                    showNotification('Procedure selected for submission');
                    
                    // Example of how you might submit the procedure
                    ...
                    if (result.success) {
                        ...
                        // Redirect after a short delay to the procedure lifecycle page instead of payment page
                        setTimeout(() => {
                            if (result.redirect) {
                                // Redirect to the procedure lifecycle page instead of payment page
                                // The URL assumes you'll create a new controller endpoint for procedure lifecycle
                                window.location.href = '${pageContext.request.contextPath}/patients/procedure/' + result.procedureId + '/lifecycle';
                            } else {
                                // Fallback to procedure lifecycle page with the selected procedure ID
                                window.location.href = '${pageContext.request.contextPath}/patients/procedure/' + procedureId + '/lifecycle';
                            }
                        }, 1500);
                    } else {
